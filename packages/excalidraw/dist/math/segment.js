...
export function lineSegmentFromPointArray(pointArray) {
    return pointArray.length === 2
        ? lineSegment(pointArray[0], pointArray[1])
        : undefined;
}
/**
 *
 ...
 * @returns
 */
export const isLineSegment = (segment) => Array.isArray(segment) &&
    segment.length === 2 &&
    isPoint(segment[0]) &&
    isPoint(segment[0]);
/**
 ...
 * @returns
 */
export const lineSegmentRotate = (l, angle, origin) => {
    return lineSegment(pointRotateRads(l[0], origin || pointCenter(l[0], l[1]), angle), pointRotateRads(l[1], origin || pointCenter(l[0], l[1]), angle));
};
/**
...
export const pointOnLineSegment = (point, line, threshold = PRECISION) => {
...
export const distanceToLineSegment = (point, line) => {
    const [x, y] = point;
