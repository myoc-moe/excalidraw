...
export const defaultGetElementLinkFromSelection = (id, type) => {
...
export const getLinkIdAndTypeFromSelection = (selectedElements, appState) => {
...
export const canCreateLinkFromElements = (selectedElements) => {
    if (selectedElements.length === 1) {
        return true;
    }
...
export const isElementLink = (url) => {
    try {
        const _url = new URL(url);
        return (_url.searchParams.has(ELEMENT_LINK_KEY) &&
...
export const parseElementLinkFromURL = (url) => {
    try {
