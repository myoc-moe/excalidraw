...
export class LinearElementEditor {
            ...
            for (const selectedPoint of selectedPointsIndices) {
                if (selectedPoint === 0 ||
                    ...
                    const bindingElement = isBindingEnabled(appState)
                        ? getHoveredElementForBinding(tupleToCoors(LinearElementEditor.getPointAtIndexGlobalCoordinates(element, selectedPoint, elementsMap)), elements, elementsMap, appState.zoom)
                        : null;
    ...
    static handlePointerDown(event, app, store, scenePointer, linearElementEditor, scene) {
        ...
        if (event.altKey && appState.editingLinearElement) {
            ...
            ret.linearElementEditor = {
                ...
                endBindingElement: getHoveredElementForBinding(scenePointer, elements, elementsMap, app.state.zoom),
            };
            ret.didAddPoint = true;
            return ret;
        }
    ...
    static handlePointerMove(event, scenePointerX, scenePointerY, app, elementsMap) {
        ...
        if (lastPoint === lastUncommittedPoint) {
            ...
            LinearElementEditor.addPoints(element, [{ point: newPoint }], elementsMap, app.state.zoom);
        }
        return {
            ...appState.editingLinearElement,
