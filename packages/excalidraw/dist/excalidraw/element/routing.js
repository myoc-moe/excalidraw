...
const getHoveredElements = (origStartGlobalPoint, origEndGlobalPoint, elementsMap, zoom) => {
    ...
    return [
        getHoveredElementForBinding(tupleToCoors(origStartGlobalPoint), elements, nonDeletedSceneElementsMap, zoom, true),
        getHoveredElementForBinding(tupleToCoors(origEndGlobalPoint), elements, nonDeletedSceneElementsMap, zoom, true),
    ];
};
