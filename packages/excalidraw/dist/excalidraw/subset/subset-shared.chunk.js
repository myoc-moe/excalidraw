 ...
 */
export const subsetToBase64 = async (arrayBuffer, codePoints) => {
    try {
 ...
 */
export const subsetToBinary = async (arrayBuffer, codePoints) => {
 ...
 */
export const toBase64 = async (arrayBuffer) => {
    let base64;
