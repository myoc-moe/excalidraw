...
export class ExcalidrawFontFace {
    urls;
    fontFace;
    static UNPKG_FALLBACK_URL = `https://unpkg.com/${import.meta.env.VITE_PKG_NAME
    ...
    async getContent(codePoints) {
        ...
        console.error(`Failed to fetch font family "${this.fontFace.family}"`, JSON.stringify(errorMessages, undefined, 2));
