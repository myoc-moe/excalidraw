...
export const actionFinalize = register({
    ...
    PanelComponent: ({ appState, updateData, data }) => (_jsx(ToolButton, { type: "button", icon: done, title: t("buttons.done"), "aria-label": t("buttons.done"), onClick: updateData, visible: appState.multiElement != null, size: data?.size || "medium", style: { pointerEvents: "all" } })),
});
