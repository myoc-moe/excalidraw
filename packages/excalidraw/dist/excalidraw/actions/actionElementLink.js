...
import { canCreateLinkFromElements, defaultGetElementLinkFromSelection, getLinkIdAndTypeFromSelection, } from "../element/elementLink";
import { t } from "../i18n";
    ...
    perform: async (elements, appState, _, app) => {
        ...
        try {
            if (window.location) {
                ...
                if (idAndType) {
                    await copyTextToSystemClipboard(app.props.generateLinkForSelection
