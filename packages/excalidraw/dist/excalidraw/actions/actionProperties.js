            ...
            elements: changeProperty(elements, appState, (el) => {
                ...
                if (isElbowArrow(newElement)) {
                    ...
                    const startHoveredElement = !newElement.startBinding &&
                        getHoveredElementForBinding(tupleToCoors(startGlobalPoint), elements, elementsMap, appState.zoom, true);
                    const endHoveredElement = !newElement.endBinding &&
                        getHoveredElementForBinding(tupleToCoors(endGlobalPoint), elements, elementsMap, appState.zoom, true);
